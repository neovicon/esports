                ...
                if ($teams->num_rows > 0) {
                    while ($team = $teams->fetch_assoc()) {
                        ...
                        if ($members->num_rows > 0) {
                            ...
                            echo "<strong>Roster:</strong><br>";
                            $totalKills = 0;
                            $totalDeaths = 0;
                            while ($member = $members->fetch_assoc()) {
                                echo "- " . htmlspecialchars($member['firstname'] . " " . $member['surname']) . " (K: " . htmlspecialchars($member['kills']) . ", D: " . htmlspecialchars($member['deaths']) . ")<br>";
                            ...
                            echo "<strong>Total Kills: <span style='color:var(--accent-success)'>$totalKills</span></strong><br>";
                            echo "<strong>Total Deaths: <span style='color:var(--accent-error)'>$totalDeaths</span></strong>";
                            echo "</div></div>";
                        } else {
